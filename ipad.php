...
Thermometer('Garage_Temp',100,340,510);
Thermometer('SD_Hall_Temperatuur',100,540,320);
Thermometer('SD_Zolder_Temperatuur',100,850,150);
Setpoint('Living',50,185,240);
Setpoint('Badkamer',50,535,620);
Setpoint('Slaapkamer',50,695,620);
Setpoint('Slaapkamer_Tobi',50,575,95);
Setpoint('Slaapkamer_Tobi',50,705,95);
Radiator('LivingZE',90,200,487);
Radiator('LivingZZ',-90,270,81);
